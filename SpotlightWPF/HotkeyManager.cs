...
namespace SpotlightWPF.Hotkey
{
    public static class HotkeyManager
    {
        private static KeyboardHook hook = new KeyboardHook();

        public static void Bind(Action<object, KeyPressedEventArgs> hotkeyHandler)
        {
            hook.KeyPressed += new EventHandler<KeyPressedEventArgs>(hotkeyHandler);
            hook.RegisterHotKey(Hotkey.ModifierKeys.Alt, Keys.C);
        }
    }
